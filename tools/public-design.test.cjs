...
const valid=(extra={})=>({...example,calculation:'manual',responseUnit:'m',minutes:'5',feasible:true,...extra});
...
test('invalid or incomplete factors are rejected instead of silently removed',()=>{
    for(const change of [{factorHigh2:''},{factorName2:example.factorName1},{factorLow1:'1',factorHigh1:'1.0'},{factorLow1:'3',factorHigh1:'2'},{factorLow1:'Infinity'},{factorCount:'4'},{factorUnit1:''},{repetitions:'2.5'},{seed:'0'},{blocking:'replicate',blockName:''},{feasible:false}]) {
