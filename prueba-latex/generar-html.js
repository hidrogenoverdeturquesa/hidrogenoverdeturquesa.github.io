...
function formula(value) {
  ...
  const symbols = { eta: 'η', cdot: '·', times: '×', approx: '≈', sum: 'Σ', Delta: 'Δ', leq: '≤', geq: '≥' };
...
function formulaMathML(value) {
  let cursor = 0;
  const symbols = { eta: 'η', alpha: 'α', beta: 'β', gamma: 'γ', Delta: 'Δ', cdot: '·', times: '×', approx: '≈', sum: 'Σ', int: '∫', leq: '≤', geq: '≥' };
  const groupText = () => {
...
<head>
  ...
  <link rel="stylesheet" href="prueba-latex/pdf.css">
