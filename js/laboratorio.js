...
(function () {
    ...
    root.innerHTML = `
        ...
        <div class="hvt-mobile-utility-dock" data-mobile-utility-dock>
            <div class="hvt-mobile-utility-dock__lab">${hasPublicPortal ? `<a class="hvt-lab__toggle hvt-lab__toggle--portal" href="/laboratorio/" aria-label="Entrar al Laboratorio HVT"><span class="hvt-lab__mark" aria-hidden="true"><svg viewBox="0 0 32 32"><path d="M12 3h8M14 3v8L6.5 24.5A3 3 0 0 0 9.1 29h13.8a3 3 0 0 0 2.6-4.5L18 11V3"/><path class="hvt-lab__liquid" d="M9 22h14M11 18.5h10"/><circle cx="13" cy="25" r="1"/><circle cx="19" cy="23.5" r="1"/></svg></span><b><span class="hvt-lab__portal-wide">Entrar al Laboratorio HVT</span><span class="hvt-lab__portal-compact">Laboratorio</span></b><span class="hvt-lab__portal-arrow" aria-hidden="true">→</span></a>` : `<button class="hvt-lab__toggle" type="button" aria-label="${t.open}" aria-expanded="false"><span class="hvt-lab__mark" aria-hidden="true"><svg viewBox="0 0 32 32"><path d="M12 3h8M14 3v8L6.5 24.5A3 3 0 0 0 9.1 29h13.8a3 3 0 0 0 2.6-4.5L18 11V3"/><path class="hvt-lab__liquid" d="M9 22h14M11 18.5h10"/><circle cx="13" cy="25" r="1"/><circle cx="19" cy="23.5" r="1"/></svg></span><b>${t.lab}</b></button>`}</div>
            <div class="hvt-mobile-utility-dock__mentor" data-mentor-slot></div>
        </div>`;
    ...
    function factorRow(number) { return `<div class="hvt-lab__factor"><input aria-label="${t.factor} ${number}" name="factorName${number}"><input aria-label="${t.low} ${number}" name="factorLow${number}"><input aria-label="${t.high} ${number}" name="factorHigh${number}"><input aria-label="${t.unit} ${number}" name="factorUnit${number}"></div>`; }
